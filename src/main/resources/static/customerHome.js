...
async function loadCustomers() {
    const response = await fetch(`/home/getAllCustomers?page=${currentPage}&size=8`, {
        headers: {
...
async function searchCustomers() {
    ...
    const response = await fetch(`/home/search?searchType=${searchType}&searchText=${searchText}&page=${currentPage}&size=10`, {
        headers: {
            'Authorization': `Bearer ${localStorage.getItem('jwtToken')}`
        }
    });
